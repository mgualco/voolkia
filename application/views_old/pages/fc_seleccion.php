        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    <fieldset disabled>
                    <div class="panel-heading">
                           Mas información para tener en Cuenta  
                    </div>
                    <fieldset disabled>
             <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                  <div class="form-group">
                                     ...
                                     <div class="form-group">
                                            <label>Representante de Recursos Humanos</label>
                ...
                <?php echo $_SESSION['nombrePerfil']?>
                    <fieldset <?php if(isset($_SESSION['nombrePerfil'])){
                        if($_SESSION['nombrePerfil'] != 'Tecnologia'){
                            echo "disabled";
                            }
                        }else{
                    ...
                    <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <fieldset <?php if(isset($_SESSION['nombrePerfil'])){
                                        if(($_SESSION['nombrePerfil'] != 'RRHH') && ($_SESSION['nombrePerfil'] != 'Admin')){
                                            echo "disabled";  
                                            }
                                        }else{
                                            //redireccionamiento a pantalla customizada con información de la causa.
