...
<head>
    ...
    <title>Recursos Humanos - Comercial Solicitud de Servicio</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Solicitud de Servicio</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                          ...
                          <li>
                            <a href="fc_cliente.html"><i class="fa fa-edit fa-fw"></i> Carga de Cliente</a>
                        </li>
                        <li>
                            <a href="fc_solicitud.html"><i class="fa fa-edit fa-fw"></i> Carga de Solicitd de Servicio</a>
                        <li>
                            <a href="fc_solicitudrh.html"><i class="fa fa-edit fa-fw"></i> Solicitud de Servicio - Recursos Humanos</a>
                        </li>   
                        <li>
                            <a href="fc_validacionit.html"><i class="fa fa-edit fa-fw"></i> Solicitud de Servicio - IT</a>
                        </li>
                        <li>
       ...
       <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-offset-1 form-group">
                    <h1 class="page-header">Validación de Solicitud de Servicio</h1>
                 </div>
                    </div>
                <!-- /.col-lg-12 -->
          <!--  </div> -->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Ingrese el puesto a cubrir">
                            </div>
                           <div class="form-group">
                                <label>Cantidad de peronas</label>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Ej. Capital Federal" >
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Ej. Belgrano">
                            </div>
                                ...
                                <div class="col-lg-6">
                                       <div class="form-group">
										...
										<div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="fecha actual">
                                        </div>
										</br>
                                        <div class="form-group">
                    ...
                    <div class="panel-body">
                            <div class="row">
                              ...
                              <div class="col-lg-3">
								...
								<div class="col-lg-2">
									...
									<input class="form-control" placeholder="DNI">
                                      ...
                                      <div class="col-lg-2">
                                       <div class="form-group">
                                            <label>Fue aceptado</label>
                                          <br>
                                          
                                            <label class="radio-inline">
                                                <input type="radio" name="optionsRadiosInline" id="optionsRadiosInline1" value="option1" >SI
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="optionsRadiosInline" id="optionsRadiosInline2" value="option2" checked>NO
                                            </label>
								...
								<div class="col-lg-6">
                                        <form role="form">
                                            <div class="form-group">
                                                <label><p >Adjuntar el Cv</p></label>
                                                <input type="file">
                                            </div>
                                        
                                            <button type="reset" class="btn btn-default btn-outline ">Eliminar Adjunto</button>
											<br><br>
											  <label>Fecha de validacion</label> 
											<input class="form-control" placeholder="fecha actual">
                                        </form>
							 ...
							 <div class="col-md-offset-4">
								 	<button type="get" class="btn btn-default" >Modificar</button>
									<button type="get" class="btn btn-default" >Agregar uno mas</button>
								 	<button type="get" class="btn btn-default" >Guardar</button>
									<button type="submit" class="btn btn-default col-md-offset-2" >Busqueda finalizada</button>   
									<br>	<br>
								 </div>
                </div>
