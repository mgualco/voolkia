                                    ...
                                    <tbody id="tbodyRegistros">
                                        {solicitud}
                                            <tr class="odd gradeX">
                                                ...
                                                <td>{tipoSolicitud}</td>
                                                <!-- <td>{nombrePuesto}</td> -->
                                                <td class="center">{razonSocial}</td>
                                                <td class="center">{Sector}</td>
                                                <td class="center">{estado}</td>
                                                 <td  class='center'><form id="form{idSolicitud}" action='../ss/detalleSolicitud' method='post'><input type='hidden' name='idSolicitud' value="{idSolicitud}"><input id="btn{idSolicitud}" type='submit' class='btn btn-default' value='Visualizar'/></form></td><!--<td class="center"><input type='button' class='btn btn-default' value='Vista preliminar' onClick='popup({idSolicitud})'></input></td>-->
                                            </tr>
                                        {/solicitud}
                                    </tbody>
                                </table>
