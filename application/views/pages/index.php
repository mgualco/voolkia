...
<head>
    ...
    <!-- Timeline CSS -->
    <link href="res/front/css/dist/css/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="res/front/css/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="res/front/css/bower_components/morrisjs/morris.css" rel="stylesheet">
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container">
                              <div class="row">
                                <div class="col-1">ssssssssss</div>
                              </div>
                              <div class="row">
                                <div class="col-2">jjjjjjjjjjjjjjjjjjjjj</div>
                                <div class="col-3">eeeeeeeeeeeee</div>
                                <div class="col-4">rrrrrrrrrrrr</div>
                              </div>
                              <div class="row">
                                ...
                              </div>
    ...
    <script src="res/front/css/bower_components/raphael/raphael-min.js"></script>
    <script src="res/front/css/bower_components/morrisjs/morris.min.js"></script>
    <script src="res/front/css/js/morris-data.js"></script>
