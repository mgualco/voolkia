...
<body>
            ...
            <div class="row">
                <div class="col-lg-12" ></br></br></br></br></br></br></br>
                    <h1 class="text-success">
                        <p class="fa fa-check" style="color:green">Se ha generado la solicitud correctamente.</p>
                    </h1>
                </div>
                <!-- /.col-lg-12 -->
					<div class="form-group col-md-offset-7">
					   <button type="button" class="btn btn-success" id="btnCargaNuevamente">Volver a cargar</button> 
					</div>
            </div>
            <!-- /.row -->
    ...
    <script type="text/javascript">
            $(document).ready(function(){
                ...
                $('#btnCargaNuevamente').click(function(){
                   window.location.href = <?php echo "'".base_url()?>ss/index<?php echo "'"?>;
                });
